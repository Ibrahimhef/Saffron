...
class DetildPage_admin extends StatefulWidget {
  final double weidth, height;
  final Meal meal;

  DetildPage_admin(this.weidth, this.height, this.meal);

  @override
  State<StatefulWidget> createState() {
    return detildPage_admin(weidth, height, meal);
  }
}

class detildPage_admin extends State<DetildPage_admin> {
  final double weidth, height;
  final Meal meal;
            ...
            child: GestureDetector(
              onTap: () {
                CoolAlert.show(
                    ...
                    confirmBtnText: "visible",
                    cancelBtnText: "Cancel",
                    confirmBtnColor: Color(0xfff2780c),
                    onConfirmBtnTap: () {
                      DatabaseService().makeVisible(meal);
